...
public class ReservationGUI extends JFrame {
    ...
    public ReservationGUI(Room room, int adult_numb, int child_numb, String check_in, String check_out){
        ...
        try {
            ...
            Helper.showMsg("Geçersiz tarih formatı: " + ex.getMessage());
            ex.printStackTrace();
        ...
        // Değerlendirme Formu 15: Kalınacak gece sayısı ve pansiyon tipine göre konaklamaya ait fiyatı gösteren kod bloğu.
        ...
        btn_add_reservation.addActionListener(e -> { // Değerlendirme Formu 16: Rezervasyon yapılan kod bloğu.
    ...
    public static boolean updateRoomStock (int stock, int id){ // Değerlendirme Formu 17: Stok kontrolü yapılan metod.
